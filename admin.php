...
function display_content(){
	...
	while($row = mysqli_fetch_assoc($result)){
		...
		echo "<a href='edit.php?id=$id' style='color:white; font-weight:bold;'><button>Edit</button></a><br><br>
			<a href='delete.php?id=$id' style='color:white; font-weight: bold;' ><button>delete</button></a><br><br>";
		echo "</div>";
		echo "</div>";
